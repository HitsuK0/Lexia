...
public class DAOAppointment extends DAO<Appointment> {
    ...
    /**
     * Retrieves all appointment requests with a TimeSlotPunctual matching the given status, across all beneficiaries.
    ...
    public List<Appointment> findAllRequestsByOptionalStatus(String status) throws SQLException {
        ...
        String query = "SELECT a.numAppointment, a.description, a.status, a.local, a.FKnumBeneficiary, a.FKnumEstablishment, a.FKTimeSlotPunctual " +
                "FROM Appointment a " +
