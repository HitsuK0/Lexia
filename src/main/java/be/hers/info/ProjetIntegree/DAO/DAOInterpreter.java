...
public class DAOInterpreter extends DAO<Interpreter> {
     ...
     * The numInterpreter is auto-generated by Postgres and retrieved via RETURNING.
    ...
    public boolean create(Interpreter objectToInsertInDB) throws SQLException {
        ...
        PreparedStatement prStatInterpreter = null;
        ...
        try {
            prStatInterpreter = connect.prepareStatement(queryInterpreter);
            prStatInterpreter.setString(1, objectToInsertInDB.getLogin());
            prStatInterpreter.setString(2, BCrypt.hashpw(objectToInsertInDB.getPassword(), BCrypt.gensalt()));
            ...
            generateID = prStatInterpreter.executeQuery();
